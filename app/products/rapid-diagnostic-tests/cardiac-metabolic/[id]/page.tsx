...
import { getMetobalictestinalTestById, MetabalicTestInterface } from '@/data/metobalic';
...
export default function TestDetail({ params }: TestDetailPageProps) {
  ...
  const [test, setTest] = useState<MetabalicTestInterface | null>(null);

  useEffect(() => {
    const foundTest = getMetobalictestinalTestById(params.id);
  ...
  if (!test) {
    return (
      <div className="py-20 text-center">
        ...
        <Button onClick={() => router.push('/products/rapid-diagnostic-tests/cardiac-metabolic')}>
  ...
  return (
    <div className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Button
          variant="outline"
          onClick={() => router.push('/products/rapid-diagnostic-tests/cardiac-metabolic')}
