...
import { getMaternalChildTestById, MaternalChildTest } from '@/data/mother_child';
...
export default function TestDetail({ params }: TestDetailPageProps) {
  ...
  const [test, setTest] = useState<MaternalChildTest | null>(null);

  useEffect(() => {
    const foundTest = getMaternalChildTestById(params.id);
  ...
  if (!test) {
    return (
      <div className="py-20 text-center">
        ...
        <Button onClick={() => router.push('/products/rapid-diagnostic-tests/maternal-child-health')}>
  ...
  return (
    <div className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Button
          variant="outline"
          onClick={() => router.push('/products/rapid-diagnostic-tests/maternal-child-health')}
